...
document.addEventListener("DOMContentLoaded", function () {
  var hamburgerMobile = document.querySelector(".navbar-toggler");
  ...
  var _checkDeviceType = checkDeviceType(),
    isDesktop = _checkDeviceType.isDesktop,
    isTablet = _checkDeviceType.isTablet,
    isMobile = _checkDeviceType.isMobile;
  if (isDesktop) {
